...
/**
 * محاسبه با کسر مقداری از پول در هر سال
 */
public class Main {
    public static void main(String args[]) {
        ...
        calc(572_000_000L, 0.40, 4, 30, 1403, 100_000_000);

        System.out.println("\n\n\n\n\n");

        calc(600_000_000L, 0.40, 4, 30, 1403, 10_000_000);


    }

    public static void calc(long P, double rate, int n, int t, int year, int bardasht) {
        ...
        while (years < t) {
            ...
            System.out.println(STR."\{++year} \{priceFormat} Toman ....-> sood = \{soodFormat} Toman   bardasht ...-> \{bardasht}");
